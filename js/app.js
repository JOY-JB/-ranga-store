    ...
    div.innerHTML = `<div class="col h-100">
      <div class="card h-100" style = "background-color: #FEF9F8;">
        ...
        <div class ="card-body">
          ...
          <p><b>Ratings:</b> ${rating} <i class="fas fa-star" style="color: #FFD700;"></i></p>
          <p><b>Review:</b> ${review} <i class="fas fa-smile"></i></p>
          <h2><b>Price:</b> $ ${product.price}</h2>
          <button onclick="addToCart(${product.price})" id="addToCart-btn" class="buy-now btn" style = "background-color: #6BB885; color : white">add to cart</button>
